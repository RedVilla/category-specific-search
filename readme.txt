...
Allow users to search with specific categories for WooCommerce. The searchbox plugin also display popup cart for add to cart action.
...
the plugins tested or theme compatibility with Hello Elementor, OceanWP, Hestia, and may more .... 

== Installation ==

1. Download the plugin from [RedVilla] (https://redvilla.net/downloads/category-specific-search-for-woocom/) or [Github] (https://github.com/redvilla/category-specific-search-for-woocom/).
