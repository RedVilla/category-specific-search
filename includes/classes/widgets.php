...
class CSSFW_Serach_Widget
{
    ...
    public function render_view($args, $instance, $form_fields, $widget_id)
    {
        ...
        do_action('cssfw_search_bar_preview', absint($style));
    ...
    public function map_and_init()
    {
        ...
        $config = array(
             ...
             * @var string (required)
             */
            'name' => esc_html__('+ Category Specific Search', 'cssfw-lang'),
            ...
            'widget_ops' => array(
                ...
                'description' => esc_html__('Category Specific Search – powerful live search plugin for WooCommerce', 'cssfw-lang'),
            ...
            'form_fields' => array(
                ...
                'title' => array(
                    ...
                    'label' => esc_html__('Title :', 'cssfw-lang'), // Optional
                    'placeholder' => esc_html__('Advance Search ', 'cssfw-lang'), // Optional

                ),

                'search_bar_style' => array(
                    'type' => 'select', // Required
                    'label' => esc_html__('Search Bar:', 'cssfw-lang'), // Optional
                    'options' => array( // Required
                        '1' => esc_html__('Style 1', 'cssfw-lang'),
                        '2.0' => esc_html__('Style 2', 'cssfw-lang'),
                        '3.0' => esc_html__('Style 3', 'cssfw-lang'),
                        '4.0' => esc_html__('Style 4', 'cssfw-lang'),
                        '5.0' => esc_html__('Style 5', 'cssfw-lang'),
                        '6.0' => esc_html__('Style 6', 'cssfw-lang'),
                    ),
