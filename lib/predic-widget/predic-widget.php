...
if (defined('PREDIC_WIDGET_VERSION')) {
    if (defined('WP_DEBUG') && WP_DEBUG)
        trigger_error(esc_html__('Framework Predic_Widget already exists. Please check if those are the same framework versions for campatibility.', 'cssfw-lang'), E_USER_WARNING);
...
class Predic_Widget
{
     ...
     */
    public function cssfw_admin_scripts($hook)
    {
