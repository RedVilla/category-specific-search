...
class Predic_Widget_Fa_Iconpicker_Field extends Predic_Widget_Form_Field
{
    ...
    public function field()
    {
         ...
         * Clear button
         */
        $html .= '<button type="button" class="button predic-widget-fa-iconpicker__clear">' . esc_html__('Clear', 'cssfw-lang') . '</button>';

        /**
         * Default value
         */
        if (!empty($this->default)) {
            $html .= '<button type="button" class="button predic-widget-fa-iconpicker__default" data-default="' . esc_attr($this->default) . '">' . esc_html__('Default', 'cssfw-lang') . '</button>';
        }
