...
if (!class_exists('WeDevs_Settings_API')) :
    class WeDevs_Settings_API
    {
        ...
        function callback_numberdisable($args)
        {
            ...
            $html       .= $this->get_field_description($args) . '<a href="https://redvilla.tech/download/apps/plugins/category-specific-search-for-woocom/" style="color:#1A6C00" target="_blank">Suggest updates</a>';
        ...
        function callback_radio($args)
        {
            ...
            $html .= $this->get_field_description($args) . '<a href="https://redvilla.tech/download/apps/plugins/category-specific-search-for-woocom/" target="_blank" style="color:#1A6C00">Suggest updates</a>';
            $html .= '</fieldset>';
        ...
        function callback_radio_img($args)
        {
            ...
            foreach ($args['options'] as $key => $label) {
                ...
                $html .= sprintf('<div class="cssfw_radio_box"><label for="wpuf-%1$s[%2$s][%3$s]" class="%4$s">',  $args['section'], $args['id'], $key, $active);
        ...
        function show_navigation()
        {
            ...
            $html .= '<a href="https://github.com/redvilla/category-specific-search-for-woocom/" target="_blank" class="nav-tab go-pro" id="go_pro-tab">Contribute</a>';
